...
static size_t kFlatOverhead = offsetof(CordRep, storage);
static size_t kMinFlatSize = 32;
static size_t kMaxFlatSize = 4096;
static size_t kMaxFlatLength = kMaxFlatSize - kFlatOverhead;
static size_t kMinFlatLength = kMinFlatSize - kFlatOverhead;
static size_t kMaxLargeFlatSize = 256 * 1024;
static size_t kMaxLargeFlatLength = kMaxLargeFlatSize - kFlatOverhead;
